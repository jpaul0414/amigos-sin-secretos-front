  ...
  return (
    <FormWrapper>
      <FormContainer>
        ...
        <QuestionWrap>
          <QuestionLabel>
            1. Conocimiento que demuestra el (la) profesor(a) de la asignatura
          </QuestionLabel>
          <QuestionSelect>
        ...
        <QuestionWrap>
          <QuestionLabel>
            3. Explicación de las (Reglas del juego) condiciones evaluativas,
            desarrollo del curso y material temático, al inicio del curso.
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
            <QuestionOption value={"5"}>Excelente</QuestionOption>
        ...
        <QuestionWrap>
          <QuestionLabel>
            7. Ejemplos dados en clase para facilitar la comprensión del tema.
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
            <QuestionOption value={"5"}>Excelente</QuestionOption>
        ...
        <QuestionWrap>
          <QuestionLabel>
            8. Estímulo a la lectura, consulta, investigación y participación
            del estudiante en clase.
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
            <QuestionOption value={"5"}>Excelente</QuestionOption>
        ...
        <QuestionWrap>
          <QuestionLabel>
            13. Los momentos evaluativos se refieren a lo explicado y tratado en
            clase.
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
        ...
        <QuestionWrap>
          <QuestionLabel>
            21. Su profesor (a) estimula , contribuye y potencia la formación en
            valores.
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
        ...
        <SectionTtitle>Género e inclusión (de uso confidencial)</SectionTtitle>
        <QuestionWrap>
          <QuestionLabel>
            22. ¿Su profesor(a) ha realizado comentarios racistas, homofóbicos,
            misóginos u otros, que lo hayan hecho sentir incómodo(a)?
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
        ...
        <QuestionWrap>
          <QuestionLabel>
            23. ¿Su profesor(a) crea escenarios de participación en condiciones
            de equidad? (Se siente con igualdad de oportunidades en la clase)
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
            <QuestionOption value={"si"}>Sí</QuestionOption>
        ...
        <QuestionWrap>
          <QuestionLabel>
            24. ¿Su profesor(a) le ha hecho comentarios insinuantes, seductores,
            provocadores, a usted o a sus compañero(a)s?
          </QuestionLabel>
          <QuestionSelect>
            <QuestionOption value={""}>--</QuestionOption>
            <QuestionOption value={"si"}>Sí</QuestionOption>
        ...
        <QuestionWrap>
          <QuestionLabel>
            25. En qué aspectos, según usted, su profesor o profesora presenta
            fortalezas?
          </QuestionLabel>
          <TextInput
            type={"text"}
